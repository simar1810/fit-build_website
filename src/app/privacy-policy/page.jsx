    ...
    <section className="bg-[#FAFAFA] min-h-screen py-12 px-6 sm:px-10 lg:px-20 xl:px-32 overflow-hidden">
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-2xl p-6 sm:p-10 lg:p-12 relative z-10 border border-gray-100">
        ...
        <div className="text-center mb-10">
          <h1 className="w-full pb-1 mx-auto text-3xl sm:text-4xl font-bold text-[#3D3D3D] mb-3 border-b-4 border-[#1a1a19]">
            Privacy Policy
          </h1>
        ...
        <div className="space-y-8 text-[#494848] leading-relaxed text-sm sm:text-base">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              ...
              &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Fit & Build.
            </li>
            <li>
            ...
            <li>
              {/* changed */}
              <strong>Website</strong> refers to Fit & Build, accessible from{" "}
              <a
                href="https://www.fit&build.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#1a1a19] hover:underline"
              >
                fit&build.com
              </a>
            </li>
          ...
          <p className="mt-8 text-xs sm:text-sm text-gray-500 italic border-t border-gray-200 pt-6">
            This Privacy Policy was last updated on <strong>December 16, 2025</strong>.
          </p>
        </div>
      </div>
    </section>
