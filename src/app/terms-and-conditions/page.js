    ...
    <section className="bg-[#FAFAFA] min-h-screen py-12 px-6 sm:px-10 lg:px-20 xl:px-32 overflow-hidden">
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-2xl p-6 sm:p-10 lg:p-12 border border-gray-100">
        <div className="text-center mb-10">
          <h1 className="w-full mx-auto text-3xl sm:text-4xl font-bold text-[#3D3D3D] mb-3 border-b-4 
          border-[#1a1a19]">
            Terms & Conditions
          </h1>
        ...
        <div className="space-y-6 text-[#494848] leading-relaxed text-sm sm:text-base">
          <h2 className="text-xl font-semibold text-[#3D3D3D] border-l-4 border-[#1a1a19] pl-3">
            Terms and Conditions
          </h2>
          <p>Welcome to Fit & Build!</p> 

          <p>
            These terms and conditions outline the rules and regulations for the use
            of Fit & Build&apos;s website, located at {" "}
            <a
              href="https://www.fit&build.com"
              target="_blank"
          ...
          <p>
            ...
            conditions. Do not continue to use Fit & Build if you do not agree to
...
{/* change */}
          <p>
            ...
            &quot;We&quot;, &quot;Our&quot;, and &quot;Us&quot; refer to Fit & Build
          ...
          <h3 className="text-lg font-semibold text-[#3D3D3D] border-l-4 border-[#1a1a19] pl-3">
            Cookies
          </h3>
{/* change */}
          <p>
            We employ the use of cookies. By accessing Fit & Build, you agree to
            use cookies in accordance with Fit & Build&apos;s Privacy Policy.
          </p>
...
{/* change */}
          <p>
            Unless otherwise stated, Fit & Build and/or its licensors own the
            intellectual property rights for all material on Nutri Health. All
            intellectual property rights are reserved. You may access this from
            Fit & Build for your own personal use subject to the restrictions set
            in these terms and conditions.
          </p>
{/* change */}
          <p>You must not:</p>
          <ul className="list-disc list-inside space-y-1">
            <li>Republish material from Fit & Build;</li>
            <li>Sell, rent, or sub-license material from Fit & Build;</li>
            <li>Reproduce, duplicate, or copy material from Fit & Build;</li>
            <li>Redistribute content from Fit & Build.</li>
          </ul>
...
{/* change */}
          <p>
            ...
            exchange opinions and information in certain areas of the website. Fit & Build does not filter, edit, publish, or review Comments prior to their
            presence on the website. Comments do not reflect the views or opinions
            of Fit & Build, its agents, and/or affiliates. Comments reflect the
            views and opinions of the person who posts them. To the extent permitted
            by applicable law, Fit & Build shall not be liable for the Comments or
...
{/* change */}
          <p>
            Fit & Build reserves the right to monitor all Comments and to remove
...
{/* change */}
          <p>
            You hereby grant Fit & Build a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            the hyperlink compensates the absence of Fit & Build; and (d) the link
...
{/* change */}
          <p>
            No use of Fit & Build&apos;s logo or other artwork will be allowed for
