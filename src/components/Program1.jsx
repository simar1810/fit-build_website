...
const Program1 = () => {
    return (
        <section className="bg-[#141414] text-[#2B2929] py-20 px-6 md:px-20 border-b border-gray-200">
            <div className=" mx-auto">
                ...
                <div className="mb-12">
                    ...
                    <h2 className="text-3xl sm:text-4xl text-white md:text-5xl font-extrabold leading-tight mb-6 text-center">
                        <span className="text-[#8b1a1a]">1:1</span> Body Transformation Coaching
                    </h2>
