...
const ReliablePartner = () => {
  return (
    <div className='w-full h-auto 2xl:h-143.5 bg-linear-to-r from-[#1a1a19] to-[#5e5e5c] px-6 sm:px-10 md:px-20 lg:px-28 2xl:px-36 text-white flex flex-col 2xl:flex-row justify-center 2xl:justify-center items-center 2xl:items-start gap-10 2xl:gap-36 relative'>
        ...
        <div className='flex flex-col sm:flex-row justify-center lg:justify-between 2xl:justify-start gap-5 sm:gap-4 items-center sm:items-start  px-4 sm:px-0'>
          <div className='w-full sm:w-56'>
            <div className='w-full h-45 overflow-hidden'>
              <Image src="/img3.jpeg" alt="check" width={100} height={100} className="w-full" />
            </div>
            <div className='flex flex-col gap-1 py-5 sm:py-7 px-4 sm:px-5 bg-white text-black lg:text-left'>
              <p className='font-bold text-xs sm:text-base'>Muscle Building</p>
              <p className='text-xs sm:text-sm font-normal'>Science-backed programs for mass and strength.</p>
            </div>                      
          </div>

          <div className='w-full sm:w-56'>
            <div className='w-full h-45 overflow-hidden'>
              <Image src="/img2.png" alt="check" width={100} height={100} className="w-full" />
            </div>
            <div className='flex flex-col gap-1 py-5 sm:py-7 px-4 sm:px-5 bg-white text-black lg:text-left'>
              <p className='font-bold text-xs sm:text-base'>Contest Prep</p>
              <p className='text-xs sm:text-sm font-normal'>Expert guidance for stage-ready physiques.</p>
            </div>                      
          </div>

          <div className='w-full sm:w-56'>
            <div className='w-full h-45 overflow-hidden'>
              <Image src="/img1.jpg" alt="check" width={100} height={100} className="w-full" />
            </div>
            <div className='flex flex-col gap-1 py-5 sm:py-7 px-4 sm:px-5 bg-white text-black lg:text-left'>
              <p className='font-bold text-xs sm:text-base'>Athletic Physique</p>
              <p className='text-xs sm:text-sm font-normal'>Sculpt your ideal aesthetic.</p>
            </div>                      
          </div>
        </div>
      </div>
