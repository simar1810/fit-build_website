...
export default function Guide() {
  return (
    <div className="">
    <section className="max-w-350 mx-auto py-20 sm:py-24 md:py-28 px-4 sm:px-8 md:px-16 xl:px-20">
      {/* Header Section */}
      <div className="max-w-5xl mx-auto text-center mb-10 px-2">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-[#2B2929]">
          Classes for Every Level and Intention
        </h2>
        <p className="text-[#363535] mt-3 text-base sm:text-lg md:text-xl font-normal">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
        ...
        <div
          ...
          className="relative ring-1 ring-[#B2B5B3] px-6 sm:px-8 md:px-10 flex flex-col items-start justify-center gap-3 sm:gap-4 py-8 sm:py-10"
        >
          <div className="w-12 sm:w-14 h-12 sm:h-14 bg-[#d4472b] mb-2 shadow-md shadow-gray-800 flex items-center justify-center">
            <Image src="/machine.png" alt="icon" width={50} height={50} className="w-7 sm:w-8 h-7 sm:h-8" />
          </div>
          <h3 className="font-extrabold text-lg sm:text-xl md:text-2xl text-white">
            Balanced Food Diet Mastery
          </h3>
          <p className="font-normal text-sm sm:text-base md:text-lg text-gray-200">
        ...
        {/* Card 2 */}
        <div className="ring-1 ring-[#B2B5B3] px-6 sm:px-8 md:px-10 flex flex-col items-start justify-center gap-3 sm:gap-4 py-8 sm:py-10">
          <div className="w-12 sm:w-14 h-12 sm:h-14 bg-[#464646] mb-2 shadow-md shadow-gray-400 flex items-center justify-center">
            <Image src="/diet-food.png" alt="icon" width={50} height={50} className="w-7 sm:w-8 h-7 sm:h-8" />
          </div>
          <h3 className="font-extrabold text-lg sm:text-xl md:text-2xl text-[#323232]">
            Mindful Eating Techniques
          </h3>
          <p className="font-normal text-sm sm:text-base md:text-lg text-[#3C3C3C]">
