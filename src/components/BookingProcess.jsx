        ...
        <section className="bg-[#141414] text-white py-20 px-6 md:px-20">
            <div className=" mx-auto">
                <h2 className="text-3xl sm:text-4xl font-extrabold mb-12 text-center leading-tight">
                    What <span className="text-[#8b1a1a]">Happens</span> Next
                </h2>
                ...
                <div className="space-y-8 relative">
                    ...
                    {[
                        ...
                        <div key={idx} className="flex items-start gap-6">
                            <div className="bg-[#8b1a1a] text-white w-9 h-9 rounded-full flex items-center justify-center font-bold shrink-0 mt-1">
                                {idx + 1}
                            </div>
                            <p className="text-xl md:text-2xl font-medium text-gray-400 leading-relaxed">
                                {step}
                            </p>
                        </div>
                    ))}
