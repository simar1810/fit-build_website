        ...
        <section className="bg-[#1a1a19] py-24 px-6 md:px-20 text-[#f4f2f2] text-center">
            <div className=" mx-auto">
                ...
                <p className="text-lg md:text-xl font-medium text-gray-300 mb-10 leading-relaxed">
                    This strategy call is not a sales pitch. It’s a conversation to understand your goals, assess fit, and decide whether working together makes sense. Not everyone is accepted.
                </p>
