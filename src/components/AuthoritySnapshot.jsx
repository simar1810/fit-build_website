        ...
        <section className="bg-[#E4DFD3] text-[#2B2929] py-16 px-6 md:px-20">
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
                ...
                <div className="flex-1 text-center lg:text-left">
                    ...
                    <p className="text-lg md:text-xl font-medium mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0 text-gray-800">
                    ...
                    <div className="bg-[#2B2929] text-[#f4f2f2] p-6 rounded-lg shadow-lg inline-block w-full lg:w-auto transform hover:scale-105 transition-transform duration-300">
