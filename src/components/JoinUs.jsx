...
const JoinUs = () => {
  return (
    <div className='bg-[#FAFFE5] w-full relative py-10 lg:py-20'>
      {/* Background Images */}
      <Image
        src='/floral-logo.png'
        alt='floral-logo'
      ...
      {/* Main Content */}
      <div className='max-w-312.5 mx-auto h-full flex flex-col md:flex-col 
      ...
      xl:gap-48 2xl:px-6'>
        ...
        <div className='flex flex-col items-center lg:items-start'>
          <h1 className='text-black font-extrabold text-xl sm:text-2xl md:text-3xl'>Why Choose</h1>
          <h1 className='text-[#d4472b] font-extrabold text-4xl sm:text-6xl lg:text-5xl mt-2'>Fit & Build</h1>
          ...
          <button className='px-5 sm:px-6 py-2.5 sm:py-3 text-white font-extrabold bg-[#2B2929] text-sm sm:text-base md:text-lg w-40 sm:w-48 md:w-56'>
            Join Us Today
          </button>
        </div>
        ...
        <div className='flex flex-col items-center md:items-start justify-center gap-5 sm:gap-7 md:gap-8 w-full md:w-[70%] lg:w-full'>
          {[
            ...
            >
              <div className='w-10 sm:w-12 md:w-14 h-10 sm:h-12 md:h-14 bg-[#d4472b] flex items-center justify-center'>
              ...
              <div className='flex flex-col gap-0.5 md:text-left'>
                <p className='font-extrabold text-[#2B2929] text-sm sm:text-base md:text-lg'>{item.title}</p>
