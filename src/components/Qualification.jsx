        ...
        <section className="bg-[#1a1a19] text-[#f4f2f2] py-20 px-6 md:px-20">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
                    <div>
                        <h3 className="text-2xl md:text-3xl font-extrabold mb-8 text-[#f4f2f2] border-b-2 border-[#2B2929] pb-4 inline-block">
                ...
                <div className="mt-16 text-center border-t border-gray-800 pt-10">
                    <p className="text-xl md:text-2xl font-bold text-white max-w-4xl mx-auto">
